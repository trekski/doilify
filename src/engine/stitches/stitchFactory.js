...
CrochetStitchFactory
  ...
  .registerClass(CrochetStitch, 'sc', ['sc', true, 1, 'mk:sequence:start; mk:sequence:finish; mv:other; mk:external:hook; mk:draw:finish:5:sc; merge:left'])
  .registerClass(CrochetStitch, 'dc', ['dc', true, 1, 'mk:sequence:start; mk:sequence:finish; mv:other; mk:external:hook; mk:draw:finish:25:dc; merge:left'])
