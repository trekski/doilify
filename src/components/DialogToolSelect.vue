    ...
    return {
      allowedTools: [
        ...
        [
          ...
          {
            tool: "recolor",
            name: "change stitch color",
            icon: "/icons/toolReColor.svg",
          },
          {
            tool: "retype",
            name: "change stitch type",
            icon: "/icons/toolReType.svg",
          },
        ],
        [
          {
            tool: "delete",
            name: "delete stitch",
            icon: "/icons/toolDelete.svg",
          },
          {
            tool: "insert",
            name: "insert new stitch",
            icon: "/icons/toolInsert.svg",
          },
          {
            tool: "duplicate",
            name: "duplicate stitch",
            icon: "/icons/toolDuplicate.svg",
          },
        ],
      ],
    };
